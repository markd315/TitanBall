...
public class GameOptions {
    ...
    private static int[] playersVal = {3,4,5,0,1,2};
    private static int[] goalieVal = {1, 0, 2};
    private static int[] bestOfVal = {1, 3, 5, 7, 9};
    private static int[] playToVal = {5, 10, 20, 30, 50, 100, 1};
    private static int[] winByVal = {2, 3, 4, 5, 10, 12, 15, 1};
    private static int[] hardWinVal = {9999, 5, 10, 20, 30, 50, 100};
    private static int[] suddenDeathVal = {10, 12, 15, 18, 20, 25, 30, 35, 60, 9999, 3, 5};
    private static int[] tieVal = {12, 15, 18, 20, 25, 30, 35, 60, 9999, 3, 5, 10};
    private static String[] playersDisp = {"3v3", "4v4", "5v5 (sep goalie)", "Single-player", "1v1", "2v2"};
    private static String[] goalieDisp = {"Goalies on", "Goalies off", "Permanent goalies"};
    private static String[] bestOfDisp = {"Best of 1", "Best of 3", "Best of 5", "Best of 7", "Best of 9"} ;
    private static String[] playToDisp = {"Play to 5", "Play to 10", "Play to 20", "Play to 30", "Play to 50", "Play to 100", "Play to 1"};
    private static String[] winByDisp = {"Win by 2", "Win by 3", "Win by 4", "Win by 5", "Win by 10", "Win by 12", "Win by 15", "Win by 1"};
    private static String[] hardWinDisp = {"OFF", "End at 5", "End at 10", "End at 20", "End at 30", "End at 50", "End at 100"};
    private static String[] suddenDeathDisp = {"Sudden Death 10:00", "Sudden Death 12:00", "Sudden Death 15:00", "Sudden Death 18:00", "Sudden Death 20:00", "Sudden Death 25:00", "Sudden Death 30:00", "Sudden Death 35:00", "Sudden Death 60:00", "Sudden Death OFF", "Sudden Death 3:00", "Sudden Death 5:00"};
    private static String[] tieDisp = {"Draw at 12:00", "Draw at 15:00", "Draw at 18:00", "Draw at 20:00", "Draw at 25:00", "Draw at 30:00", "Draw at 35:00", "Draw at 60:00", "Draw OFF", "Draw at 3:00", "Draw at 5:00", "Draw at 10:00"};
