...
export const ABILITY_TOOLTIPS = {
    ...
    "fortress.t3.biggermodels": { title: "Bigger Character Models", desc: "Passive. Increases hitbox size and collision radius of all allied units (+25%), but grants opponents +3px steal radius." },
    ...
    "empowerment.t3.discipline": { title: "Discipline", desc: "Passive. Grants a permanent +2 Cooldown and +2 Effect Duration to friendly heroes." },
    "empowerment.t4.forecheck": { title: "Forecheck", desc: "Passive. Grants +4px steal radius to friendly units in the middle third." },
