...
- `split[8]` - **`tieIndex`** *(CRITICAL: Literal Minutes)*: Time in minutes before an automatic draw is forced (e.g. `12` for 12:00 minutes).
...
- **Standard 4v4 Headless Balance Benchmark**:
  `"/1/0/1/10/2/9999/10/12/2/1"` (4v4, Goalies on, Bo1, Play to 10, Win by 2, Hard win OFF, Sudden death at 10:00, Draw at 12:00, Hard AI difficulty, Hybrid bot mode).
- **Default 1v1 Scrimmage**:
  `"/1/1/1/5/2/9999/10/12"` (1v1 scrimmage, play to 5, win by 2).
